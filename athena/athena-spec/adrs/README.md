...
Canonical ADRs for the Athena platform. Use [ADR-Template.md](../templates/ADR-Template.md) for new decisions.

| ADR | Title | Status |
|-----|-------|--------|
| [ADR-0001](ADR-0001-pandas-parquet-mvp-data.md) | pandas + Parquet for MVP data | Accepted |
