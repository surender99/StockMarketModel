# APS-FS-METADATA-001 — Feature Metadata

> **APS ID:** APS-FS-METADATA-001  
> **Requirement ID:** REQ-APS-FS-METADATA-001  
...
Feature Metadata for the Athena data platform (feature store domain).

## Responsibilities

- Feature name
- params
- data_version linkage
...
- [ ] APS-FS-METADATA-001 responsibilities covered by wired `athena-core` modules
