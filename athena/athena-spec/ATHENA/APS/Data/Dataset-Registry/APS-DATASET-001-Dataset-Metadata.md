# APS-DATASET-001 — Dataset Metadata

> **APS ID:** APS-DATASET-001  
> **Requirement ID:** REQ-APS-DATASET-001  
> **Maps to:** REQ-DATA-REGISTRY-001  
...
Dataset Metadata for the Athena data platform (dataset registry domain).
...
- [ ] APS-DATASET-001 responsibilities covered by wired `athena-core` modules
- [ ] Maps to REQ-DATA-REGISTRY-001 acceptance criteria
