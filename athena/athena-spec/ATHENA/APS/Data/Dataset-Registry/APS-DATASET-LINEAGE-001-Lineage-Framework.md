# APS-DATASET-LINEAGE-001 — Lineage Framework

> **APS ID:** APS-DATASET-LINEAGE-001  
> **Requirement ID:** REQ-APS-DATASET-LINEAGE-001  
> **Maps to:** REQ-DATA-VERSION-001  
...
Lineage Framework for the Athena data platform (dataset registry domain).
...
- `athena-core/src/athena_core/domain/data/lineage.py`
...
- [ ] APS-DATASET-LINEAGE-001 responsibilities covered by wired `athena-core` modules
- [ ] Maps to REQ-DATA-VERSION-001 acceptance criteria
