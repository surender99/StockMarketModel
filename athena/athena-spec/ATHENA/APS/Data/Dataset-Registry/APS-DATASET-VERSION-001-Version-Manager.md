# APS-DATASET-VERSION-001 — Version Manager

> **APS ID:** APS-DATASET-VERSION-001  
> **Requirement ID:** REQ-APS-DATASET-VERSION-001  
...
Version Manager for the Athena data platform (dataset registry domain).
...
- [ ] APS-DATASET-VERSION-001 responsibilities covered by wired `athena-core` modules
