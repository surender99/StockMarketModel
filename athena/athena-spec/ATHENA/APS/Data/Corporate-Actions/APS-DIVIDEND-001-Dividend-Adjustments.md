# APS-DIVIDEND-001 — Dividend Adjustments

> **APS ID:** APS-DIVIDEND-001  
> **Requirement ID:** REQ-APS-DIVIDEND-001  
...
Dividend Adjustments for the Athena data platform (corporate actions domain).

## Responsibilities

- Cash dividend adjustment policy
...
- [ ] APS-DIVIDEND-001 spec published with REQ ID
