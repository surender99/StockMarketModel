# APS-SPLIT-001 — Split Adjustments

> **APS ID:** APS-SPLIT-001  
> **Requirement ID:** REQ-APS-SPLIT-001  
...
Split Adjustments for the Athena data platform (corporate actions domain).

## Responsibilities

- Forward/reverse split adjustment
...
- [ ] APS-SPLIT-001 spec published with REQ ID
