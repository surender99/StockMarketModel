# APS-SYMBOL-001 — Symbol Registry

> **APS ID:** APS-SYMBOL-001  
> **Requirement ID:** REQ-APS-SYMBOL-001  
...
Symbol Registry for the Athena data platform (instrument master domain).
...
- `athena-core/config/instruments.yaml`
...
- [ ] Core subset of APS-SYMBOL-001 implemented
- [ ] Deferred capabilities documented in spec
- [ ] Maps to REQ-DATA-INSTR-001 where applicable
