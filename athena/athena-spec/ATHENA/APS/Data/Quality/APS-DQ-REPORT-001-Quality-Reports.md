# APS-DQ-REPORT-001 — Quality Reports

> **APS ID:** APS-DQ-REPORT-001  
> **Requirement ID:** REQ-APS-DQ-REPORT-001  
...
Quality Reports for the Athena data platform (quality domain).

## Responsibilities

- Structured issue reports for ingest gate
...
- [ ] APS-DQ-REPORT-001 responsibilities covered by wired `athena-core` modules
