# APS-VALIDATE-CORP-001 — Corporate Action Validation

> **APS ID:** APS-VALIDATE-CORP-001  
> **Requirement ID:** REQ-APS-VALIDATE-CORP-001  
...
Corporate Action Validation for the Athena data platform (data validation domain).

## Responsibilities

- Post-split price discontinuity checks
...
- [ ] APS-VALIDATE-CORP-001 spec published with REQ ID
- [ ] Deferred — no silent stub in production path
- [ ] Future implementation traces to REQ-DATA-QUALITY-001
