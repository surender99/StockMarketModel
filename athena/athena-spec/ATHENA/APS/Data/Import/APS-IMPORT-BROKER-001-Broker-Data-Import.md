# APS-IMPORT-BROKER-001 — Broker Data Import

> **APS ID:** APS-IMPORT-BROKER-001  
> **Requirement ID:** REQ-APS-IMPORT-BROKER-001  
...
Broker Data Import for the Athena data platform (import domain).

## Responsibilities

- Broker-specific fill and quote feeds
...
- [ ] APS-IMPORT-BROKER-001 spec published with REQ ID
