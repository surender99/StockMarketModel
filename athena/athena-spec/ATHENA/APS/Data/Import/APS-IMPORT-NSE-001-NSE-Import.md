# APS-IMPORT-NSE-001 — NSE Import

> **APS ID:** APS-IMPORT-NSE-001  
> **Requirement ID:** REQ-APS-IMPORT-NSE-001  
...
NSE Import for the Athena data platform (import domain).

## Responsibilities

- NSE bhavcopy / API adapters
...
- [ ] APS-IMPORT-NSE-001 spec published with REQ ID
