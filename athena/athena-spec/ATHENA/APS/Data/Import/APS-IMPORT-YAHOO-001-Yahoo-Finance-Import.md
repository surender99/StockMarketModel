# APS-IMPORT-YAHOO-001 — Yahoo Finance Import

> **APS ID:** APS-IMPORT-YAHOO-001  
> **Requirement ID:** REQ-APS-IMPORT-YAHOO-001  
...
Yahoo Finance Import for the Athena data platform (import domain).
...
- `athena-core/src/athena_core/infrastructure/yfinance_client.py`
- `athena-core/src/athena_core/application/ingest_ohlcv.py`
...
- [ ] APS-IMPORT-YAHOO-001 responsibilities covered by wired `athena-core` modules
