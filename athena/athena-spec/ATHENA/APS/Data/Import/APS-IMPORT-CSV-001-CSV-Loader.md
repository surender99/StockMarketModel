# APS-IMPORT-CSV-001 — CSV Loader

> **APS ID:** APS-IMPORT-CSV-001  
> **Requirement ID:** REQ-APS-IMPORT-CSV-001  
...
CSV Loader for the Athena data platform (import domain).

## Responsibilities

- Delimited OHLCV import
...
- [ ] APS-IMPORT-CSV-001 spec published with REQ ID
