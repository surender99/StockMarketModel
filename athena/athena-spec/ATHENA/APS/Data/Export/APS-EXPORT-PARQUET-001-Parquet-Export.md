# APS-EXPORT-PARQUET-001 — Parquet Export

> **APS ID:** APS-EXPORT-PARQUET-001  
> **Requirement ID:** REQ-APS-EXPORT-PARQUET-001  
...
Parquet Export for the Athena data platform (export domain).
...
- [ ] Core subset of APS-EXPORT-PARQUET-001 implemented
