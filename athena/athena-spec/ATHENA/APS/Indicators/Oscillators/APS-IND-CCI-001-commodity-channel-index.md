...
Commodity Channel Index for the Athena indicators platform (oscillators domain).

## Responsibilities

- Commodity Channel Index computation
...
- [ ] Maps to REQ-IND-IND-CCI-001 where applicable
