# APS-PRICE-OHLC4-001 — OHLC4 Price

> **APS ID:** APS-PRICE-OHLC4-001  
> **Requirement ID:** REQ-APS-PRICE-OHLC4-001  
> **Maps to:** REQ-IND-PRICE-OHLC4-001  
> **Phase:** 3 — Indicators  
...
OHLC4 Price for the Athena indicators platform (price transformations domain).

## Responsibilities

- OHLC4 Price computation
...
- [ ] APS-PRICE-OHLC4-001 responsibilities covered by wired `athena-core` modules
- [ ] Maps to REQ-IND-PRICE-OHLC4-001 where applicable
