# APS-IND-PSAR-001 — Parabolic SAR

> **APS ID:** APS-IND-PSAR-001  
> **Requirement ID:** REQ-APS-IND-PSAR-001  
> **Maps to:** REQ-IND-IND-PSAR-001  
> **Phase:** 3 — Indicators  
...
Parabolic SAR for the Athena indicators platform (trend indicators domain).
...
- [ ] APS-IND-PSAR-001 spec published with REQ ID
- [ ] Deferred — no silent stub in production path
- [ ] Future implementation traces to REQ-IND-IND-PSAR-001
