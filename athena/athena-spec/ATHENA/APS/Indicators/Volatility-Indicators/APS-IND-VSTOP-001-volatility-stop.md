# APS-IND-VSTOP-001 — Volatility Stop

> **APS ID:** APS-IND-VSTOP-001  
> **Requirement ID:** REQ-APS-IND-VSTOP-001  
> **Maps to:** REQ-IND-IND-VSTOP-001  
> **Phase:** 3 — Indicators  
...
Volatility Stop for the Athena indicators platform (volatility indicators domain).

## Responsibilities

- Volatility Stop computation
...
- [ ] APS-IND-VSTOP-001 spec published with REQ ID
- [ ] Deferred — no silent stub in production path
- [ ] Future implementation traces to REQ-IND-IND-VSTOP-001
