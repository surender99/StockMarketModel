...
Chaikin Money Flow for the Athena indicators platform (volume indicators domain).

## Responsibilities

- Chaikin Money Flow computation
...
- [ ] Maps to REQ-IND-IND-CMF-001 where applicable
