# APS-IND-CRSI-001 — Connors RSI

> **APS ID:** APS-IND-CRSI-001  
> **Requirement ID:** REQ-APS-IND-CRSI-001  
> **Maps to:** REQ-IND-IND-CRSI-001  
> **Phase:** 3 — Indicators  
...
Connors RSI for the Athena indicators platform (composite indicators domain).

## Responsibilities

- Connors RSI computation
...
- [ ] APS-IND-CRSI-001 spec published with REQ ID
- [ ] Deferred — no silent stub in production path
- [ ] Future implementation traces to REQ-IND-IND-CRSI-001
