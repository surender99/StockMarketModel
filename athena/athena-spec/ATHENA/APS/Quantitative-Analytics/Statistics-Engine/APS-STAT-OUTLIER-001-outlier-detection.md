# APS-STAT-OUTLIER-001 — Outlier Detection

> **APS ID:** APS-STAT-OUTLIER-001  
> **Requirement ID:** REQ-APS-STAT-OUTLIER-001  
...
Outlier Detection for the Athena quantitative analytics and risk intelligence platform (QARIP).
...
- [ ] APS-STAT-OUTLIER-001 spec published with REQ ID
