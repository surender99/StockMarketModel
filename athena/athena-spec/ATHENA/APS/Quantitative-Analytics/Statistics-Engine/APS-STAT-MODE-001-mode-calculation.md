# APS-STAT-MODE-001 — Mode Calculation

> **APS ID:** APS-STAT-MODE-001  
> **Requirement ID:** REQ-APS-STAT-MODE-001  
...
Mode Calculation for the Athena quantitative analytics and risk intelligence platform (QARIP).
...
- [ ] APS-STAT-MODE-001 spec published with REQ ID
