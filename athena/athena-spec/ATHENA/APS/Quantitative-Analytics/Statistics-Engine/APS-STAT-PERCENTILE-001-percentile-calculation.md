# APS-STAT-PERCENTILE-001 — Percentile Calculation

> **APS ID:** APS-STAT-PERCENTILE-001  
> **Requirement ID:** REQ-APS-STAT-PERCENTILE-001  
...
Percentile Calculation for the Athena quantitative analytics and risk intelligence platform (QARIP).
...
- [ ] APS-STAT-PERCENTILE-001 spec published with REQ ID
