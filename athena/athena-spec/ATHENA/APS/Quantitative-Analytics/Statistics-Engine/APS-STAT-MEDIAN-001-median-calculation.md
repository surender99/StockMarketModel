# APS-STAT-MEDIAN-001 — Median Calculation

> **APS ID:** APS-STAT-MEDIAN-001  
> **Requirement ID:** REQ-APS-STAT-MEDIAN-001  
...
Median Calculation for the Athena quantitative analytics and risk intelligence platform (QARIP).
...
- [ ] APS-STAT-MEDIAN-001 spec published with REQ ID
