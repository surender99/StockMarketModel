# APS-STAT-ZSCORE-001 — Z-Score Normalization

> **APS ID:** APS-STAT-ZSCORE-001  
> **Requirement ID:** REQ-APS-STAT-ZSCORE-001  
...
Z-Score Normalization for the Athena quantitative analytics and risk intelligence platform (QARIP).
...
- [ ] APS-STAT-ZSCORE-001 spec published with REQ ID
