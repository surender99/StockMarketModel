# APS-STAT-VARIANCE-001 — Variance Calculation

> **APS ID:** APS-STAT-VARIANCE-001  
> **Requirement ID:** REQ-APS-STAT-VARIANCE-001  
...
Variance Calculation for the Athena quantitative analytics and risk intelligence platform (QARIP).
...
- [ ] APS-STAT-VARIANCE-001 spec published with REQ ID
