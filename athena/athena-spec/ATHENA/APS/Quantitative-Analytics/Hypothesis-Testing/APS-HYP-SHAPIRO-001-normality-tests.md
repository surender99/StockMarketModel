# APS-HYP-SHAPIRO-001 — Normality Tests

> **APS ID:** APS-HYP-SHAPIRO-001  
> **Requirement ID:** REQ-APS-HYP-SHAPIRO-001  
...
Normality Tests for the Athena quantitative analytics and risk intelligence platform (QARIP).
...
- [ ] APS-HYP-SHAPIRO-001 spec published with REQ ID
