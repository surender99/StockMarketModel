# APS-PROB-ENTROPY-001 — Entropy

> **APS ID:** APS-PROB-ENTROPY-001  
> **Requirement ID:** REQ-APS-PROB-ENTROPY-001  
...
Entropy for the Athena quantitative analytics and risk intelligence platform (QARIP).
...
- [ ] APS-PROB-ENTROPY-001 spec published with REQ ID
