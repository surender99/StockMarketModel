# APS-TS-LAG-001 — Lag Features

> **APS ID:** APS-TS-LAG-001  
> **Requirement ID:** REQ-APS-TS-LAG-001  
...
Lag Features for the Athena quantitative analytics and risk intelligence platform (QARIP).
...
- [ ] APS-TS-LAG-001 spec published with REQ ID
