# APS-TS-ADF-001 — ADF Test

> **APS ID:** APS-TS-ADF-001  
> **Requirement ID:** REQ-APS-TS-ADF-001  
...
ADF Test for the Athena quantitative analytics and risk intelligence platform (QARIP).
...
- [ ] APS-TS-ADF-001 spec published with REQ ID
