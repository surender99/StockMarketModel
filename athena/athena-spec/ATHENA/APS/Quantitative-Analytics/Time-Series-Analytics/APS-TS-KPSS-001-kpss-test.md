# APS-TS-KPSS-001 — KPSS Test

> **APS ID:** APS-TS-KPSS-001  
> **Requirement ID:** REQ-APS-TS-KPSS-001  
...
KPSS Test for the Athena quantitative analytics and risk intelligence platform (QARIP).
...
- [ ] APS-TS-KPSS-001 spec published with REQ ID
