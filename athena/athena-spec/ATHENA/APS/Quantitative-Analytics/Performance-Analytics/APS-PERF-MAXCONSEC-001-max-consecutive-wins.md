# APS-PERF-MAXCONSEC-001 — Max Consecutive Wins

> **APS ID:** APS-PERF-MAXCONSEC-001  
> **Requirement ID:** REQ-APS-PERF-MAXCONSEC-001  
...
Max Consecutive Wins for the Athena quantitative analytics and risk intelligence platform (QARIP).
...
- [ ] APS-PERF-MAXCONSEC-001 spec published with REQ ID
