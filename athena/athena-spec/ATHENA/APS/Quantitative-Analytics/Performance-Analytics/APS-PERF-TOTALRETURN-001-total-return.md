# APS-PERF-TOTALRETURN-001 — Total Return

> **APS ID:** APS-PERF-TOTALRETURN-001  
> **Requirement ID:** REQ-APS-PERF-TOTALRETURN-001  
...
Total Return for the Athena quantitative analytics and risk intelligence platform (QARIP).
...
- [ ] APS-PERF-TOTALRETURN-001 spec published with REQ ID
