# APS-SCENARIO-RATE-001 — Rate Shock

> **APS ID:** APS-SCENARIO-RATE-001  
> **Requirement ID:** REQ-APS-SCENARIO-RATE-001  
...
Rate Shock for the Athena quantitative analytics and risk intelligence platform (QARIP).
...
- [ ] APS-SCENARIO-RATE-001 spec published with REQ ID
