# APS-UXCOMP-CAT-005 — UX Components Capability 5

> **APS ID:** APS-UXCOMP-CAT-005  
> **Requirement ID:** REQ-APS-UXCOMP-CAT-005  
...
UX Components Capability 5 for the Athena Visualization, Decision Support & User Experience platform (VDSUX).
...
- [ ] APS-UXCOMP-CAT-005 spec published with REQ ID
