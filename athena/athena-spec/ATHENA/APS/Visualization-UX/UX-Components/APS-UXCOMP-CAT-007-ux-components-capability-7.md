# APS-UXCOMP-CAT-007 — UX Components Capability 7

> **APS ID:** APS-UXCOMP-CAT-007  
> **Requirement ID:** REQ-APS-UXCOMP-CAT-007  
...
UX Components Capability 7 for the Athena Visualization, Decision Support & User Experience platform (VDSUX).
...
- [ ] APS-UXCOMP-CAT-007 spec published with REQ ID
