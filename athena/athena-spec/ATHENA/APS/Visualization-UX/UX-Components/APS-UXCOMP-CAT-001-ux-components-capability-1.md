# APS-UXCOMP-CAT-001 — UX Components Capability 1

> **APS ID:** APS-UXCOMP-CAT-001  
> **Requirement ID:** REQ-APS-UXCOMP-CAT-001  
...
UX Components Capability 1 for the Athena Visualization, Decision Support & User Experience platform (VDSUX).
...
- [ ] APS-UXCOMP-CAT-001 spec published with REQ ID
