# APS-UXCOMP-CAT-008 — UX Components Capability 8

> **APS ID:** APS-UXCOMP-CAT-008  
> **Requirement ID:** REQ-APS-UXCOMP-CAT-008  
...
UX Components Capability 8 for the Athena Visualization, Decision Support & User Experience platform (VDSUX).
...
- [ ] APS-UXCOMP-CAT-008 spec published with REQ ID
