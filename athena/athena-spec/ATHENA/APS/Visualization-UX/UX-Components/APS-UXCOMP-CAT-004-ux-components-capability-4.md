# APS-UXCOMP-CAT-004 — UX Components Capability 4

> **APS ID:** APS-UXCOMP-CAT-004  
> **Requirement ID:** REQ-APS-UXCOMP-CAT-004  
...
UX Components Capability 4 for the Athena Visualization, Decision Support & User Experience platform (VDSUX).
...
- [ ] APS-UXCOMP-CAT-004 spec published with REQ ID
