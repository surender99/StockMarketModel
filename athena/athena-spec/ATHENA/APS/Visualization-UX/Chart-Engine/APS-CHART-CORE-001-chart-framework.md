# APS-CHART-CORE-001 — Chart Framework

> **APS ID:** APS-CHART-CORE-001  
> **Requirement ID:** REQ-APS-CHART-CORE-001  
...
Chart Framework for the Athena Visualization, Decision Support & User Experience platform (VDSUX).
...
- [ ] APS-CHART-CORE-001 spec published with REQ ID
