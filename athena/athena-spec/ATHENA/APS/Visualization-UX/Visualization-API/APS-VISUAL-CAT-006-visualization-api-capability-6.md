# APS-VISUAL-CAT-006 — Visualization API Capability 6

> **APS ID:** APS-VISUAL-CAT-006  
> **Requirement ID:** REQ-APS-VISUAL-CAT-006  
...
Visualization API Capability 6 for the Athena Visualization, Decision Support & User Experience platform (VDSUX).
...
- [ ] APS-VISUAL-CAT-006 spec published with REQ ID
