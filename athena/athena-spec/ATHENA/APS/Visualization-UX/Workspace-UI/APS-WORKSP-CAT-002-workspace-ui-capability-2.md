# APS-WORKSP-CAT-002 — Workspace UI Capability 2

> **APS ID:** APS-WORKSP-CAT-002  
> **Requirement ID:** REQ-APS-WORKSP-CAT-002  
...
Workspace UI Capability 2 for the Athena Visualization, Decision Support & User Experience platform (VDSUX).
...
- [ ] APS-WORKSP-CAT-002 spec published with REQ ID
