# APS-WORKSP-CAT-006 — Workspace UI Capability 6

> **APS ID:** APS-WORKSP-CAT-006  
> **Requirement ID:** REQ-APS-WORKSP-CAT-006  
...
Workspace UI Capability 6 for the Athena Visualization, Decision Support & User Experience platform (VDSUX).
...
- [ ] APS-WORKSP-CAT-006 spec published with REQ ID
