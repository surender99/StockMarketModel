# APS-WORKSP-CAT-008 — Workspace UI Capability 8

> **APS ID:** APS-WORKSP-CAT-008  
> **Requirement ID:** REQ-APS-WORKSP-CAT-008  
...
Workspace UI Capability 8 for the Athena Visualization, Decision Support & User Experience platform (VDSUX).
...
- [ ] APS-WORKSP-CAT-008 spec published with REQ ID
