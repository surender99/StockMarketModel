# APS-WORKSP-CAT-003 — Workspace UI Capability 3

> **APS ID:** APS-WORKSP-CAT-003  
> **Requirement ID:** REQ-APS-WORKSP-CAT-003  
...
Workspace UI Capability 3 for the Athena Visualization, Decision Support & User Experience platform (VDSUX).
...
- [ ] APS-WORKSP-CAT-003 spec published with REQ ID
