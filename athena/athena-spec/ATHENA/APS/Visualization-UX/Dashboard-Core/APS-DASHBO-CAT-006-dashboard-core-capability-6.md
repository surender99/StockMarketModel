# APS-DASHBO-CAT-006 — Dashboard Core Capability 6

> **APS ID:** APS-DASHBO-CAT-006  
> **Requirement ID:** REQ-APS-DASHBO-CAT-006  
...
Dashboard Core Capability 6 for the Athena Visualization, Decision Support & User Experience platform (VDSUX).
...
- [ ] APS-DASHBO-CAT-006 spec published with REQ ID
