# APS-DASHBO-CAT-008 — Dashboard Core Capability 8

> **APS ID:** APS-DASHBO-CAT-008  
> **Requirement ID:** REQ-APS-DASHBO-CAT-008  
...
Dashboard Core Capability 8 for the Athena Visualization, Decision Support & User Experience platform (VDSUX).
...
- [ ] APS-DASHBO-CAT-008 spec published with REQ ID
