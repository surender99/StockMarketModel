# APS-DASHBO-CAT-005 — Dashboard Core Capability 5

> **APS ID:** APS-DASHBO-CAT-005  
> **Requirement ID:** REQ-APS-DASHBO-CAT-005  
...
Dashboard Core Capability 5 for the Athena Visualization, Decision Support & User Experience platform (VDSUX).
...
- [ ] APS-DASHBO-CAT-005 spec published with REQ ID
