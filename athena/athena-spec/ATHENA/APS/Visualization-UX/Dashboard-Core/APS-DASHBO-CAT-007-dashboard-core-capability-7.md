# APS-DASHBO-CAT-007 — Dashboard Core Capability 7

> **APS ID:** APS-DASHBO-CAT-007  
> **Requirement ID:** REQ-APS-DASHBO-CAT-007  
...
Dashboard Core Capability 7 for the Athena Visualization, Decision Support & User Experience platform (VDSUX).
...
- [ ] APS-DASHBO-CAT-007 spec published with REQ ID
