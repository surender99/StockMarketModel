# APS-DASHBO-CAT-002 — Dashboard Core Capability 2

> **APS ID:** APS-DASHBO-CAT-002  
> **Requirement ID:** REQ-APS-DASHBO-CAT-002  
...
Dashboard Core Capability 2 for the Athena Visualization, Decision Support & User Experience platform (VDSUX).
...
- [ ] APS-DASHBO-CAT-002 spec published with REQ ID
