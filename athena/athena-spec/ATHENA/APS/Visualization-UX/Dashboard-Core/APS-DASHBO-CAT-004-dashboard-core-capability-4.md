# APS-DASHBO-CAT-004 — Dashboard Core Capability 4

> **APS ID:** APS-DASHBO-CAT-004  
> **Requirement ID:** REQ-APS-DASHBO-CAT-004  
...
Dashboard Core Capability 4 for the Athena Visualization, Decision Support & User Experience platform (VDSUX).
...
- [ ] APS-DASHBO-CAT-004 spec published with REQ ID
