# APS-SMC-ORDERBLOCK-001 — Order Block

> **APS ID:** APS-SMC-ORDERBLOCK-001  
> **Requirement ID:** REQ-APS-SMC-ORDERBLOCK-001  
> **Phase:** 4 — Patterns  
...
Order Block for the Athena patterns platform (smart money concepts domain).
...
- [ ] APS-SMC-ORDERBLOCK-001 spec published with REQ ID
