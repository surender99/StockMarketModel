# APS-SWING-CORE-001 — Swing High Low

> **APS ID:** APS-SWING-CORE-001  
> **Requirement ID:** REQ-APS-SWING-CORE-001  
> **Phase:** 4 — Patterns  
> **Domain:** Swing Engine  
...
Swing High Low for the Athena patterns platform (swing engine domain).
...
- [ ] APS-SWING-CORE-001 spec published with REQ ID
