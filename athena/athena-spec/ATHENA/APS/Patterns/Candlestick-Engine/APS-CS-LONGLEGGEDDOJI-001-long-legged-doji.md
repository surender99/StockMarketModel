# APS-CS-LONGLEGGEDDOJI-001 — Long Legged Doji

> **APS ID:** APS-CS-LONGLEGGEDDOJI-001  
> **Requirement ID:** REQ-APS-CS-LONGLEGGEDDOJI-001  
> **Phase:** 4 — Patterns  
...
Long Legged Doji for the Athena patterns platform (candlestick engine domain).
...
- [ ] APS-CS-LONGLEGGEDDOJI-001 spec published with REQ ID
