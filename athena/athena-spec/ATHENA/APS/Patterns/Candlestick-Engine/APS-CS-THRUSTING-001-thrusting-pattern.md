# APS-CS-THRUSTING-001 — Thrusting Pattern

> **APS ID:** APS-CS-THRUSTING-001  
> **Requirement ID:** REQ-APS-CS-THRUSTING-001  
> **Phase:** 4 — Patterns  
...
Thrusting Pattern for the Athena patterns platform (candlestick engine domain).
...
- [ ] APS-CS-THRUSTING-001 spec published with REQ ID
