# APS-CS-ONNECK-001 — On Neck

> **APS ID:** APS-CS-ONNECK-001  
> **Requirement ID:** REQ-APS-CS-ONNECK-001  
> **Phase:** 4 — Patterns  
...
On Neck for the Athena patterns platform (candlestick engine domain).
...
- [ ] APS-CS-ONNECK-001 spec published with REQ ID
