# APS-CS-HARAMI-001 — Harami

> **APS ID:** APS-CS-HARAMI-001  
> **Requirement ID:** REQ-APS-CS-HARAMI-001  
> **Phase:** 4 — Patterns  
...
Harami for the Athena patterns platform (candlestick engine domain).
...
- [ ] APS-CS-HARAMI-001 spec published with REQ ID
