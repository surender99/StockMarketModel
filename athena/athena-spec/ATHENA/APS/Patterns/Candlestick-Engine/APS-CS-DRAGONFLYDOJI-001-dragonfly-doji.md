# APS-CS-DRAGONFLYDOJI-001 — Dragonfly Doji

> **APS ID:** APS-CS-DRAGONFLYDOJI-001  
> **Requirement ID:** REQ-APS-CS-DRAGONFLYDOJI-001  
> **Phase:** 4 — Patterns  
...
Dragonfly Doji for the Athena patterns platform (candlestick engine domain).
...
- [ ] APS-CS-DRAGONFLYDOJI-001 spec published with REQ ID
