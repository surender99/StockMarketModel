# APS-CS-SPINNINGTOP-001 — Spinning Top

> **APS ID:** APS-CS-SPINNINGTOP-001  
> **Requirement ID:** REQ-APS-CS-SPINNINGTOP-001  
> **Phase:** 4 — Patterns  
...
Spinning Top for the Athena patterns platform (candlestick engine domain).
...
- [ ] APS-CS-SPINNINGTOP-001 spec published with REQ ID
