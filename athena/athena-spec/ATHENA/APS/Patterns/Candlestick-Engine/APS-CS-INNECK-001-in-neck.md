# APS-CS-INNECK-001 — In Neck

> **APS ID:** APS-CS-INNECK-001  
> **Requirement ID:** REQ-APS-CS-INNECK-001  
> **Phase:** 4 — Patterns  
...
In Neck for the Athena patterns platform (candlestick engine domain).
...
- [ ] APS-CS-INNECK-001 spec published with REQ ID
