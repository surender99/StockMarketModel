# APS-CS-GRAVESTONEDOJI-001 — Gravestone Doji

> **APS ID:** APS-CS-GRAVESTONEDOJI-001  
> **Requirement ID:** REQ-APS-CS-GRAVESTONEDOJI-001  
> **Phase:** 4 — Patterns  
...
Gravestone Doji for the Athena patterns platform (candlestick engine domain).
...
- [ ] APS-CS-GRAVESTONEDOJI-001 spec published with REQ ID
