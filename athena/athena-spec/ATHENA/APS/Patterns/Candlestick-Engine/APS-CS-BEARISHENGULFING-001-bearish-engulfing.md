# APS-CS-BEARISHENGULFING-001 — Bearish Engulfing

> **APS ID:** APS-CS-BEARISHENGULFING-001  
> **Requirement ID:** REQ-APS-CS-BEARISHENGULFING-001  
> **Phase:** 4 — Patterns  
...
Bearish Engulfing for the Athena patterns platform (candlestick engine domain).
...
- [ ] APS-CS-BEARISHENGULFING-001 spec published with REQ ID
