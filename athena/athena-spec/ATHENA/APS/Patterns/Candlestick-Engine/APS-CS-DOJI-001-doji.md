# APS-CS-DOJI-001 — Doji

> **APS ID:** APS-CS-DOJI-001  
> **Requirement ID:** REQ-APS-CS-DOJI-001  
> **Phase:** 4 — Patterns  
...
Doji for the Athena patterns platform (candlestick engine domain).
...
- [ ] APS-CS-DOJI-001 spec published with REQ ID
