# APS-CP-DOUBLEBOTTOM-001 — Double Bottom

> **APS ID:** APS-CP-DOUBLEBOTTOM-001  
> **Requirement ID:** REQ-APS-CP-DOUBLEBOTTOM-001  
> **Phase:** 4 — Patterns  
...
Double Bottom for the Athena patterns platform (chart patterns domain).
...
- [ ] APS-CP-DOUBLEBOTTOM-001 spec published with REQ ID
