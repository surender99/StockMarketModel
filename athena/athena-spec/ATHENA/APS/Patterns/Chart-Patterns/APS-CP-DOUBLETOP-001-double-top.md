# APS-CP-DOUBLETOP-001 — Double Top

> **APS ID:** APS-CP-DOUBLETOP-001  
> **Requirement ID:** REQ-APS-CP-DOUBLETOP-001  
> **Phase:** 4 — Patterns  
...
Double Top for the Athena patterns platform (chart patterns domain).
...
- [ ] APS-CP-DOUBLETOP-001 spec published with REQ ID
