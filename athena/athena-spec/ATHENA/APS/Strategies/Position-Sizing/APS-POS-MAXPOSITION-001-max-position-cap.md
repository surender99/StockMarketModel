# APS-POS-MAXPOSITION-001 — Max Position Cap

> **APS ID:** APS-POS-MAXPOSITION-001  
> **Requirement ID:** REQ-APS-POS-MAXPOSITION-001  
> **Phase:** 5 — Strategies  
...
Max Position Cap for the Athena strategies platform (position sizing domain).
...
- [ ] APS-POS-MAXPOSITION-001 spec published with REQ ID
