# APS-POS-EQUALWEIGHT-001 — Equal Weight Sizing

> **APS ID:** APS-POS-EQUALWEIGHT-001  
> **Requirement ID:** REQ-APS-POS-EQUALWEIGHT-001  
> **Phase:** 5 — Strategies  
...
Equal Weight Sizing for the Athena strategies platform (position sizing domain).
...
- [ ] APS-POS-EQUALWEIGHT-001 spec published with REQ ID
