# APS-POS-RISKPERCENT-001 — Risk Percent Sizing

> **APS ID:** APS-POS-RISKPERCENT-001  
> **Requirement ID:** REQ-APS-POS-RISKPERCENT-001  
> **Phase:** 5 — Strategies  
...
Risk Percent Sizing for the Athena strategies platform (position sizing domain).
...
- [ ] APS-POS-RISKPERCENT-001 spec published with REQ ID
