# APS-DSL-RISK-001 — DSL Risk Block

> **APS ID:** APS-DSL-RISK-001  
> **Requirement ID:** REQ-APS-DSL-RISK-001  
> **Phase:** 5 — Strategies  
> **Domain:** Strategy DSL  
...
DSL Risk Block for the Athena strategies platform (strategy dsl domain).
...
- [ ] APS-DSL-RISK-001 spec published with REQ ID
