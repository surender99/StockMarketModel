# APS-DSL-VALIDATOR-001 — DSL Validator

> **APS ID:** APS-DSL-VALIDATOR-001  
> **Requirement ID:** REQ-APS-DSL-VALIDATOR-001  
> **Phase:** 5 — Strategies  
> **Domain:** Strategy DSL  
...
DSL Validator for the Athena strategies platform (strategy dsl domain).
...
- [ ] APS-DSL-VALIDATOR-001 spec published with REQ ID
