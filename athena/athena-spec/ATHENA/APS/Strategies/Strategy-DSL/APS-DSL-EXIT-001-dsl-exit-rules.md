# APS-DSL-EXIT-001 — DSL Exit Rules

> **APS ID:** APS-DSL-EXIT-001  
> **Requirement ID:** REQ-APS-DSL-EXIT-001  
> **Phase:** 5 — Strategies  
> **Domain:** Strategy DSL  
...
DSL Exit Rules for the Athena strategies platform (strategy dsl domain).
...
- [ ] APS-DSL-EXIT-001 spec published with REQ ID
