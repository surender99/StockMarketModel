# APS-MTF-RESAMPLE-001 — Bar Resampling

> **APS ID:** APS-MTF-RESAMPLE-001  
> **Requirement ID:** REQ-APS-MTF-RESAMPLE-001  
> **Phase:** 5 — Strategies  
...
Bar Resampling for the Athena strategies platform (multi timeframe domain).
...
- [ ] APS-MTF-RESAMPLE-001 spec published with REQ ID
