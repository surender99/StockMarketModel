# APS-MTF-CONTEXT-001 — Higher Timeframe Context

> **APS ID:** APS-MTF-CONTEXT-001  
> **Requirement ID:** REQ-APS-MTF-CONTEXT-001  
> **Phase:** 5 — Strategies  
...
Higher Timeframe Context for the Athena strategies platform (multi timeframe domain).
...
- [ ] APS-MTF-CONTEXT-001 spec published with REQ ID
