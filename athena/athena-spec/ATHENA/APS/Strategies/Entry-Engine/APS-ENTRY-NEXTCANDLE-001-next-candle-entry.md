# APS-ENTRY-NEXTCANDLE-001 — Next Candle Entry

> **APS ID:** APS-ENTRY-NEXTCANDLE-001  
> **Requirement ID:** REQ-APS-ENTRY-NEXTCANDLE-001  
> **Phase:** 5 — Strategies  
> **Domain:** Entry Engine  
...
Next Candle Entry for the Athena strategies platform (entry engine domain).
...
- [ ] APS-ENTRY-NEXTCANDLE-001 spec published with REQ ID
