# APS-TEMPLATE-RSI-001 — RSI Template

> **APS ID:** APS-TEMPLATE-RSI-001  
> **Requirement ID:** REQ-APS-TEMPLATE-RSI-001  
> **Phase:** 5 — Strategies  
...
RSI Template for the Athena strategies platform (strategy templates domain).
...
- [ ] APS-TEMPLATE-RSI-001 spec published with REQ ID
