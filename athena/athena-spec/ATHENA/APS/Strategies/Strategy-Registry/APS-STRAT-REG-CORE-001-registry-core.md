# APS-STRAT-REG-CORE-001 — Registry Core

> **APS ID:** APS-STRAT-REG-CORE-001  
> **Requirement ID:** REQ-APS-STRAT-REG-CORE-001  
> **Phase:** 5 — Strategies  
...
Registry Core for the Athena strategies platform (strategy registry domain).
...
- [ ] APS-STRAT-REG-CORE-001 spec published with REQ ID
