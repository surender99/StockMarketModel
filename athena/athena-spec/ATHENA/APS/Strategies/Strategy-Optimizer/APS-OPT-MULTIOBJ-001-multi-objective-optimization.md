# APS-OPT-MULTIOBJ-001 — Multi Objective Optimization

> **APS ID:** APS-OPT-MULTIOBJ-001  
> **Requirement ID:** REQ-APS-OPT-MULTIOBJ-001  
> **Phase:** 5 — Strategies  
...
Multi Objective Optimization for the Athena strategies platform (strategy optimizer domain).
...
- [ ] APS-OPT-MULTIOBJ-001 spec published with REQ ID
