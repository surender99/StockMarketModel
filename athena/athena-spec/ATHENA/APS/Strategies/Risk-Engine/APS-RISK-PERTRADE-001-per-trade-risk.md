# APS-RISK-PERTRADE-001 — Per Trade Risk

> **APS ID:** APS-RISK-PERTRADE-001  
> **Requirement ID:** REQ-APS-RISK-PERTRADE-001  
> **Phase:** 5 — Strategies  
> **Domain:** Risk Engine  
...
Per Trade Risk for the Athena strategies platform (risk engine domain).
...
- [ ] APS-RISK-PERTRADE-001 spec published with REQ ID
