# APS-RISK-PORTFOLIO-001 — Portfolio Risk Context

> **APS ID:** APS-RISK-PORTFOLIO-001  
> **Requirement ID:** REQ-APS-RISK-PORTFOLIO-001  
> **Phase:** 5 — Strategies  
> **Domain:** Risk Engine  
...
Portfolio Risk Context for the Athena strategies platform (risk engine domain).
...
- [ ] APS-RISK-PORTFOLIO-001 spec published with REQ ID
