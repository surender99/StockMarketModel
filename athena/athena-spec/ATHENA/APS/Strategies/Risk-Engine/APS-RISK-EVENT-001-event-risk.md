# APS-RISK-EVENT-001 — Event Risk

> **APS ID:** APS-RISK-EVENT-001  
> **Requirement ID:** REQ-APS-RISK-EVENT-001  
> **Phase:** 5 — Strategies  
> **Domain:** Risk Engine  
...
Event Risk for the Athena strategies platform (risk engine domain).
...
- [ ] APS-RISK-EVENT-001 spec published with REQ ID
