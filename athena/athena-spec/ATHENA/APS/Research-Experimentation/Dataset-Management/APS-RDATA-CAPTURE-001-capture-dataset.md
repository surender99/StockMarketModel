# APS-RDATA-CAPTURE-001 — Capture Dataset

> **APS ID:** APS-RDATA-CAPTURE-001  
> **Requirement ID:** REQ-APS-RDATA-CAPTURE-001  
...
Capture Dataset for the Athena quantitative research and experimentation platform (QREP).
...
- [ ] APS-RDATA-CAPTURE-001 spec published with REQ ID
