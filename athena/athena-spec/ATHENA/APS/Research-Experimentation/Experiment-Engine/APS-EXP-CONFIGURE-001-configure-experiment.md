# APS-EXP-CONFIGURE-001 — Configure Experiment

> **APS ID:** APS-EXP-CONFIGURE-001  
> **Requirement ID:** REQ-APS-EXP-CONFIGURE-001  
...
Configure Experiment for the Athena quantitative research and experimentation platform (QREP).
...
- [ ] APS-EXP-CONFIGURE-001 spec published with REQ ID
