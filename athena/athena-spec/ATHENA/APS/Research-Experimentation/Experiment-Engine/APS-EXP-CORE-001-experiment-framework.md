# APS-EXP-CORE-001 — Experiment Framework

> **APS ID:** APS-EXP-CORE-001  
> **Requirement ID:** REQ-APS-EXP-CORE-001  
...
Experiment Framework for the Athena quantitative research and experimentation platform (QREP).
...
- [ ] APS-EXP-CORE-001 spec published with REQ ID
