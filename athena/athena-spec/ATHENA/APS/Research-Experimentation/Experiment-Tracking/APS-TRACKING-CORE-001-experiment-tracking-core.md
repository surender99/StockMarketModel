# APS-TRACKING-CORE-001 — Experiment Tracking Core

> **APS ID:** APS-TRACKING-CORE-001  
> **Requirement ID:** REQ-APS-TRACKING-CORE-001  
...
Experiment Tracking Core for the Athena quantitative research and experimentation platform (QREP).
...
- [ ] APS-TRACKING-CORE-001 spec published with REQ ID
