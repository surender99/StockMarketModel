# APS-RMS-PRETRADE-001 — Pre-trade checks

> **APS ID:** APS-RMS-PRETRADE-001  
> **Requirement ID:** REQ-APS-RMS-PRETRADE-001  
...
Pre-trade checks for the Athena Enterprise Trading & Operations platform (ETOP).
...
- [ ] APS-RMS-PRETRADE-001 spec published with REQ ID
