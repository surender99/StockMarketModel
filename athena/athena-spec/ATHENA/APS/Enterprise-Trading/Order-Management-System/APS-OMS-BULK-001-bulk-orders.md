# APS-OMS-BULK-001 — Bulk orders

> **APS ID:** APS-OMS-BULK-001  
> **Requirement ID:** REQ-APS-OMS-BULK-001  
...
Bulk orders for the Athena Enterprise Trading & Operations platform (ETOP).
...
- [ ] APS-OMS-BULK-001 spec published with REQ ID
