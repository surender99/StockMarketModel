# APS-OMS-QUEUE-001 — Order queue

> **APS ID:** APS-OMS-QUEUE-001  
> **Requirement ID:** REQ-APS-OMS-QUEUE-001  
...
Order queue for the Athena Enterprise Trading & Operations platform (ETOP).
...
- [ ] APS-OMS-QUEUE-001 spec published with REQ ID
