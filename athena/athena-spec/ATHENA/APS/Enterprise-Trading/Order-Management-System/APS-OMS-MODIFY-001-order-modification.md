# APS-OMS-MODIFY-001 — Order modification

> **APS ID:** APS-OMS-MODIFY-001  
> **Requirement ID:** REQ-APS-OMS-MODIFY-001  
...
Order modification for the Athena Enterprise Trading & Operations platform (ETOP).
...
- [ ] APS-OMS-MODIFY-001 spec published with REQ ID
