# APS-DEPLOY-CAT-002 — Deployment Pipeline Capability 2

> **APS ID:** APS-DEPLOY-CAT-002  
> **Requirement ID:** REQ-APS-DEPLOY-CAT-002  
...
Deployment Pipeline Capability 2 for the Athena Enterprise Trading & Operations platform (ETOP).
...
- [ ] APS-DEPLOY-CAT-002 spec published with REQ ID
