# APS-DEPLOY-CAT-003 — Deployment Pipeline Capability 3

> **APS ID:** APS-DEPLOY-CAT-003  
> **Requirement ID:** REQ-APS-DEPLOY-CAT-003  
...
Deployment Pipeline Capability 3 for the Athena Enterprise Trading & Operations platform (ETOP).
...
- [ ] APS-DEPLOY-CAT-003 spec published with REQ ID
