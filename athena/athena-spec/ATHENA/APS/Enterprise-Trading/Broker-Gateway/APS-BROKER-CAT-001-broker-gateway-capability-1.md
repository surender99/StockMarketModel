# APS-BROKER-CAT-001 — Broker Gateway Capability 1

> **APS ID:** APS-BROKER-CAT-001  
> **Requirement ID:** REQ-APS-BROKER-CAT-001  
...
Broker Gateway Capability 1 for the Athena Enterprise Trading & Operations platform (ETOP).
...
- [ ] APS-BROKER-CAT-001 spec published with REQ ID
