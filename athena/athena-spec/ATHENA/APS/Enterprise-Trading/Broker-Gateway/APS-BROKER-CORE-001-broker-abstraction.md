# APS-BROKER-CORE-001 — Broker abstraction

> **APS ID:** APS-BROKER-CORE-001  
> **Requirement ID:** REQ-APS-BROKER-CORE-001  
...
Broker abstraction for the Athena Enterprise Trading & Operations platform (ETOP).
...
- [ ] APS-BROKER-CORE-001 spec published with REQ ID
