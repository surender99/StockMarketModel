# APS-BROKER-CAT-003 — Broker Gateway Capability 3

> **APS ID:** APS-BROKER-CAT-003  
> **Requirement ID:** REQ-APS-BROKER-CAT-003  
...
Broker Gateway Capability 3 for the Athena Enterprise Trading & Operations platform (ETOP).
...
- [ ] APS-BROKER-CAT-003 spec published with REQ ID
