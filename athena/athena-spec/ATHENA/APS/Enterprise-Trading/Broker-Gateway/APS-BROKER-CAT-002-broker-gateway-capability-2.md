# APS-BROKER-CAT-002 — Broker Gateway Capability 2

> **APS ID:** APS-BROKER-CAT-002  
> **Requirement ID:** REQ-APS-BROKER-CAT-002  
> **Phase:** 14 — Enterprise Trading & Operations  
> **Domain:** Broker Gateway  
> **Source:** `References/PHASE14 - Enterprise Trading & Operations Platform (ETOP).docx`  
> **Implementation status:** Deferred

## Objective

Broker Gateway Capability 2 for the Athena Enterprise Trading & Operations platform (ETOP).
...
- [ ] APS-BROKER-CAT-002 spec published with REQ ID
